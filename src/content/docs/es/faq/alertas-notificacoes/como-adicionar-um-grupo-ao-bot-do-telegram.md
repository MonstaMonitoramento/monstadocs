---
title: "¿Cómo añadir el bot de Monsta a un grupo de Telegram?"
---

Monsta utiliza un bot de Telegram para el envío de alertas. Para añadir el bot a un grupo de Telegram y recibir las alertas en el grupo, haga lo siguiente:

- **En Monsta**, acceda al menú **"Grupos de Alerta"** y haga clic en el grupo en el que desea recibir los mensajes;
- Dentro del grupo seleccionado, acceda a la pestaña **"Alertas Monsta"**;
- Seleccione la opción **"Monsta: Telegram"** y haga clic para activarla;
- Haga clic en el botón **"Gestionar usuarios registrados"**;
- Copie el **código** que aparece en la pantalla;
