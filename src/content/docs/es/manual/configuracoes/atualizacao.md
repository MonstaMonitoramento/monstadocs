...
| ![image.png](/src/assets/images/ms61znje-qrizj4u3.png) | **Verificación Manual**: Además de la programación automática, puede ejecutar una comprobación de nuevas versiones de forma inmediata en cualquier momento. • Al hacer clic en este botón, Monsta consulta instantáneamente los servidores de actualización para verificar la disponibilidad de nuevas versiones, ignorando temporalmente la programación diaria configurada. • **Comportamiento**: En caso de que haya una versión más reciente disponible, el sistema preguntará si desea realizar la actualización. Si ya está en la versión más reciente, un mensaje informará que el sistema está actualizado. |
