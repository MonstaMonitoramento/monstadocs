...
| Opción | Descripción |
| :--- | :--- |
| ![image-1755089526369.png](/src/assets/images/p79_OLpimage-1755089526369.png) | **Comando**: Indica dónde debe estar instalado el software certbot. |
| ![image-1755089721901.png](/src/assets/images/p79_image-1755089721901.png) | **Dominio**: Permite al usuario indicar el/los dominio(s) por los que Monsta responderá. <aside class="starlight-aside starlight-aside--caution"><p class="starlight-aside__title">Atención</p>Asegúrese de que la URL indicada tenga acceso al puerto 80/TCP en Monsta, ya que certbot utiliza esa comunicación para generar y renovar el/los certificado(s).</aside> |
| ![image-1755089819102.png](/src/assets/images/p79_image-1755089819102.png) | **Correo electrónico**: Let's Encrypt necesita una dirección de correo electrónico para contacto. Proporcione un correo electrónico de su propiedad. |
...
| Opción | Descripción |
| :--- | :--- |
| ![image-1755090193642.png](/src/assets/images/p79_image-1755090193642.png) | **Clave pública**: Es la clave que cifrará los datos enviados desde el navegador al servidor de Monsta. Utilice este campo para subir el archivo. |
| ![image-1755090205657.png](/src/assets/images/p79_image-1755090205657.png) | **Clave privada**: Es la clave que descifra la información proveniente de la clave pública. Utilice este campo para subir el archivo correspondiente. |