...
![image-1647448202544.png](/src/assets/images/p61_image-1647448202544.png)

---

![image-1647448799678.png](/src/assets/images/p61_image-1647448799678.png)
**Importar Plantillas**: Permite seleccionar un archivo de plantilla para importar. 

---

![image-1647448005833.png](/src/assets/images/p61_image-1647448005833.png)
**Filtro de búsqueda**: Cuando se utiliza, muestra solo las plantillas que contienen ese texto en su nombre.

---

![image-1647448121838.png](/src/assets/images/p61_image-1647448121838.png)
...
![image-1647448227188.png](/src/assets/images/p61_image-1647448227188.png)
**Lista de Plantillas**: Presenta una lista con todas las plantillas disponibles en el sistema.

---

![image-1739983220633.png](/src/assets/images/p61_image-1739983220633.png)
...
| Icono | Descripción |
| :---: | :--- |
| ![image-1647448422172.png](/src/assets/images/p61_image-1647448422172.png) | **Eliminar**: Elimina la plantilla seleccionada. |
| ![image-1647448460969.png](/src/assets/images/p61_image-1647448460969.png) | **Editar**: Edita las propiedades de la plantilla, como nombre, descripción e icono. |

### Crear/Editar una Plantilla

<a id="criareditar-um-template"></a>
![image-1647450145680.png](/src/assets/images/p61_image-1647450145680.png)

| Opción | Descripción |
| :---: | :--- |
| ![image-1647450183069.png](/src/assets/images/p61_image-1647450183069.png) | **Icono de la Plantilla**: Permite seleccionar un icono para la plantilla desde una biblioteca ya existente o a partir de una nueva imagen. |
...
![image-1739984216883.png](/src/assets/images/p61_image-1739984216883.png)

---

---

![image-1739984247217.png](/src/assets/images/p61_image-1739984247217.png)
**Nombre de la Plantilla**: Indica el nombre de la plantilla seleccionada.

---

![image-1739984391202.png](/src/assets/images/p61_image-1739984391202.png)
**Exportar**: Exporta los monitores seleccionados a un archivo.

---

![image-1739984511244.png](/src/assets/images/p61_image-1739984511244.png)
**Editar Plantilla**: Edita las propiedades de la plantilla, como nombre, descripción e icono.

---

![image-1647449193273.png](/src/assets/images/p61_image-1647449193273.png)
**Filtro de búsqueda**: Cuando se utiliza, muestra solo los monitores que contienen ese texto en su nombre.

---

![image-1647449307274.png](/src/assets/images/p61_image-1647449307274.png)
**Nuevo Monitor**: Crea un nuevo monitor para la plantilla seleccionada. Para más información, consulte xxxxxxx.

---

![image-1647449372287.png](/src/assets/images/p61_image-1647449372287.png)
...
| Icono | Descripción |
| :---: | :--- |
| ![image-1647449752980.png](/src/assets/images/p61_image-1647449752980.png) | **Clonar**: Clona el monitor a una plantilla seleccionada. |
| ![image-1647449785056.png](/src/assets/images/p61_image-1647449785056.png) | **Eliminar**: Elimina el monitor seleccionado. | 
...
![image-1769000706570.png](/src/assets/images/p61_image-1769000706570.png)

| Opción | Descripción |
| :---: | :--- |
| ![image-1739984579878.png](/src/assets/images/p61_image-1739984579878.png) | **Icono**: Permite seleccionar un icono para la plantilla desde una biblioteca ya existente o a partir de una nueva imagen y también sirve como vista previa de cómo se mostrará el monitor en la pantalla. |
...
| ![image-1769000749924.png](/src/assets/images/p61_image-1769000749924.png) | Al editar un monitor y hacer clic en este botón, el sistema permite replicar los cambios en otros dispositivos simultáneamente. Tras hacer clic, seleccione en la lista los dispositivos que deben recibir la nueva configuración. |
...
![image-1739984753223.png](/src/assets/images/p61_image-1739984753223.png)

| Opción | Descripción |
| :---: | :--- |
| ![image-1647535774368.png](/src/assets/images/p61_image-1647535774368.png) | **Activar Instancias**: Activa la selección de instancias para el monitor. |
| ![image-1647535820722.png](/src/assets/images/p61_image-1647535820722.png) | **Método de búsqueda**: Método de búsqueda utilizado para localizar las instancias. |
...
![image-1769002820448.png](/src/assets/images/p61_image-1769002820448.png)

---

![image-1647537210606.png](/src/assets/images/p61_image-1647537210606.png)
...
| Icono | Descripción |
| :---: | :--- |
![image-1647537418530.png](/src/assets/images/p61_image-1647537418530.png) | **Ordenación**: Alterna la posición de la métrica para mostrarse en el gráfico. | 
![image-1647537403522.png](/src/assets/images/p61_image-1647537403522.png) | **Eliminar**: Elimina la métrica seleccionada. | 

---

![image-1647537518634.png](/src/assets/images/p61_image-1647537518634.png)
**Añadir**: Añade una nueva métrica.

---

![image-1647537560886.png](/src/assets/images/p61_image-1647537560886.png)
...
![image-1647538051533.png](/src/assets/images/p61_image-1647538051533.png)
...
![image-1647538111673.png](/src/assets/images/p61_image-1647538111673.png)
**Color**: Color de la métrica que se presentará al acceder a su gráfico.

---

![image-1647538237011.png](/src/assets/images/p61_image-1647538237011.png)
**Nombre**: Nombre de la métrica que se presentará al acceder a su gráfico.

---

![image-1739986248546.png](/src/assets/images/p61_image-1739986248546.png)
**Unidad**: Unidad de medida de la métrica.

---

![image-1647538419774.png](/src/assets/images/p61_image-1647538419774.png)
...
![image-1647538571119.png](/src/assets/images/p61_image-1647538571119.png)
...
![image-1739986284648.png](/src/assets/images/p61_image-1739986284648.png)
...
![image-1647539136617.png](/src/assets/images/p61_image-1647539136617.png)
...
| Opción | Descripción |
| :---: | :--- |
| ![image-1647539259537.png](/src/assets/images/p61_image-1647539259537.png) | **Invertir**: Invierte el porcentaje de alerta. Por defecto, un valor menor se considerará mejor. |
| ![image-1647539419645.png](/src/assets/images/p61_image-1647539419645.png) | **Barra de porcentajes**: Permite configurar visualmente los límites de alerta. Arrastre los selectores para determinar los porcentajes de uso que activan los estados de "Advertencia" y "Crítico". |
| ![image-1647539324004.png](/src/assets/images/p61_image-1647539324004.png) | **Valores de los porcentajes**: Debajo de la barra porcentual, el sistema muestra el valor numérico exacto correspondiente a la posición de los marcadores. |

---

![image-1647539661996.png](/src/assets/images/p61_image-1647539661996.png)
...
| Opción | Descripción |
| :---: | :--- |
| ![image-1647539740732.png](/src/assets/images/p61_image-1647539740732.png) | **Valor de Advertencia**: Define la condición para que la métrica entre en estado de advertencia. |
| ![image-1647539844543.png](/src/assets/images/p61_image-1647539844543.png) | **Valor Crítico**: Define la condición para que la métrica entre en estado crítico. |

---


![image-1739986395801.png](/src/assets/images/p61_image-1739986395801.png)
...
| Opción | Descripción |
| :---: | :--- |
| ![image-1647540152635.png](/src/assets/images/p61_image-1647540152635.png) | **Botón Probar**: Prueba la fuente contra un dispositivo seleccionado. |
| ![image-1647540263038.png](/src/assets/images/p61_image-1647540263038.png) | **Botón Eliminar**: Elimina la fuente de datos del valor seleccionado. |
...
![image-1647539918188.png](/src/assets/images/p61_image-1647539918188.png)
...
| Opción | Descripción |
| :---: | :--- |
| ![image-1647540152635.png](/src/assets/images/p61_image-1647540152635.png) | **Botón Probar**: Prueba el script contra un dispositivo seleccionado. |
| ![image-1647540263038.png](/src/assets/images/p61_image-1647540263038.png) | **Botón Eliminar**: Elimina la fuente de datos del valor seleccionado. |
...
![image-1739986497220.png](/src/assets/images/p61_image-1739986497220.png)

| Opción | Descripción |
| :---: | :--- |
| ![image-1739986525205.png](/src/assets/images/p61_image-1739986525205.png) | **Nombre**: Define un nombre para el parámetro. |
| ![image-1739986588973.png](/src/assets/images/p61_image-1739986588973.png) | **Tipo**: Es el tipo de información que debe recibir el parámetro. El tipo "Opción" mostrará una lista proveniente de la pestaña "Instancias". |
| ![image-1739986692649.png](/src/assets/images/p61_image-1739986692649.png) | **Valor predeterminado**: Define un valor predeterminado para el parámetro al crear el monitor. Esta opción no está disponible para el tipo "Opción". |
| ![image-1739986788958.png](/src/assets/images/p61_image-1739986788958.png) | **Descripción del campo**: Es el texto que se mostrará al usuario durante la adición de monitores a los dispositivos. |
| ![image-1647546204637.png](/src/assets/images/p61_image-1647546204637.png) | **Opción de Campo Obligatorio**: Exige que el parámetro tenga algún valor. No se permiten campos en blanco. |
| ![image-1647546282966.png](/src/assets/images/p61_image-1647546282966.png) | **Opción de Campo que se repite**: Permite al usuario insertar el mismo campo varias veces con valores diferentes. |
| ![image-1647546340415.png](/src/assets/images/p61_image-1647546340415.png) | **Posición**: Alterna la posición del parámetro en la lista. |
| ![image-1647546392820.png](/src/assets/images/p61_image-1647546392820.png) | **Botón Eliminar**: Elimina el parámetro seleccionado. |
