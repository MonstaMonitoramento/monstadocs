...
| ![image-1756129930291.png](../../../../../assets/images/p37_image-1756129930291.png) | **Grupo Nube**: Este grupo envía alertas en caso de pérdida de comunicación entre Monsta y la nube en [https://mind.monsta.com.br](https://mind.monsta.com.br). Este recurso es muy útil en casos como caída del enlace a Internet en la empresa o apagado inesperado del servidor sin el conocimiento del usuario. Este grupo no puede eliminarse del sistema y no está disponible para dispositivos o monitores.<br />El color de su borde indica el estado de la conexión con la nube:<br />- **Verde**: Comunicación establecida;<br />- **Rojo**: Fallo en la comunicación. |
| ![image-1756129950105.png](../../../../../assets/images/p37_image-1756129950105.png) | **Grupo predeterminado**: Este grupo es obligatorio en el sistema y no puede eliminarse, solo modificarse. El número mostrado en la esquina superior derecha del recuadro del grupo se refiere al número de dispositivos que lo utilizan en sus alertas. Cuando el recuadro del grupo se presenta en color gris, esto indica que no tiene alertas activadas. |
| ![image-1732710101229.png](../../../../../assets/images/p37_image-1732710101229.png) | **Alertas activas**: Los iconos presentados dentro del recuadro del grupo indican qué alertas están activas en este momento para él. |
| ![image-1732710190977.png](../../../../../assets/images/p37_image-1732710190977.png) | **Eliminar Grupo**: Elimina el grupo seleccionado. <aside class="starlight-aside starlight-aside--caution"><p class="starlight-aside__title">Atención</p>Sólo será permitido eliminar un grupo cuando éste no forme parte de ningún dispositivo o monitor. Puede obtener esa información en la pestaña [Membros](#membros) al editar el grupo.</aside> |
| ![image-1645792184443.png](../../../../../assets/images/p37_image-1645792184443.png) | **Editar Grupo**: En esta opción el usuario podrá añadir y eliminar dispositivos y monitores que formen parte de este grupo, así como definir los tipos de alerta que se enviarán, sus destinatarios y los horarios de activación permitidos para los mensajes. |
...
En esta pestaña se definen el icono, el nombre y el comentario sobre el grupo.

![image-1732711113493.png](../../../../../assets/images/p37_image-1732711113493.png)

| Opción | Descripción |
| :---: | :--- |
| ![image-1732710589288.png](../../../../../assets/images/p37_image-1732710589288.png) | Es posible asignar una imagen al grupo de alerta que se mostrará en pantalla. |
| **Nombre del grupo de alerta** | Es el nombre que se mostrará en la pantalla de grupos, así como lo que se mostrará al editar la opción de grupos de alerta dentro de los dispositivos o monitores. |
...
| Opción | Descripción |
| :---: | :--- |
| **Todos** | Este componente muestra todos los dispositivos existentes en Monsta. Haga clic en un dispositivo para seleccionarlo y utilice los botones a un lado para añadirlo al grupo. |
...
Esta pestaña muestra las alertas predeterminadas de Monsta que utilizan nuestra nube para enviarse a los destinatarios. Las opciones de envío disponibles son Correo electrónico, SMS y Telegram. Las Alertas Monsta no necesitan configuraciones especiales ya que se integran automáticamente a la nube durante la instalación del software. 

![image-1732712034593.png](../../../../../assets/images/p37_image-1732712034593.png) 
Para facilitar la visualización, las alertas activas se marcan con el icono mostrado arriba en su pestaña.
...
| ![image-1732712469323.png](../../../../../assets/images/p37_image-1732712469323.png) | Envía una prueba a los destinatarios existentes. Esta opción es útil para verificar si todos los destinos están configurados correctamente, como dirección de correo electrónico, número de SMS o usuarios de Telegram. |
...
| ![image-1732712693761.png](../../../../../assets/images/p37_image-1732712693761.png) | Aquí es posible elegir el objeto que se utilizará para el envío de alertas. Puede usar esta opción para recibir alertas solo cuando el dispositivo quede incomunicable, pero optar por no recibir una alerta si el monitor de CPU genera una alarma por alta utilización. |
| **Plantilla del mensaje** | Las plantillas son modelos de mensajes que se enviarán a los usuarios. Puede personalizar cómo se enviarán los mensajes a sus destinatarios. Para más información, consulte "Plantillas de mensaje". |
| ![image-1732713267486.png](../../../../../assets/images/p37_image-1732713267486.png) | Esta opción está disponible solo para Telegram. Muestra los usuarios que forman parte del grupo y permite eliminarlos manualmente. Para agregar un usuario, deberá usar el código que aparece al inicio de esta pantalla y enviárselo al bot "MonstaTecnologiaBot". Las instrucciones sobre cómo proceder están especificadas en esta misma pantalla. |
| ![image-1732713616303.png](../../../../../assets/images/p37_image-1732713616303.png) | Los periodos son los intervalos de tiempo en los que los alertas podrán enviarse. Al crear un grupo, el predeterminado es 24x7. Los cuadros en gris indican que los horarios seleccionados están inactivos y Monsta no enviará alertas al grupo durante esos intervalos de tiempo. |
...
**Barra de visualización**: Permite al usuario estipular la cantidad de elementos por página y el periodo durante el cual la información debe mostrarse en pantalla.


| Información | Descripción |
| :---: | :--- |
| ![image-1739974961714.png](../../../../../assets/images/p37_image-1739974961714.png) | **Estado**: Informa el estado del mensaje enviado a un usuario. |
| ![image-1739975105124.png](../../../../../assets/images/p37_image-1739975105124.png) | **Tipo**: Indica a través de qué medio se envió el mensaje. |
...
| ![image-1739975341938.png](../../../../../assets/images/p37_image-1739975341938.png) | **Origen**: Indica el dispositivo y el monitor que originaron la alerta. |
...
Con nuestras plantillas, puede crear mensajes personalizados para cada tipo de alerta, asegurando que la información más importante sea entregada a los responsables de forma rápida y eficiente. Elija entre una variedad de variables para incluir detalles como el nombre del dispositivo, la gravedad de la alerta y la hora de ocurrencia, entre otros.
...
| Icono | Descripción |
| :---: | :--- |
| ![image-1732727824893.png](../../../../../assets/images/p37_image-1732727824893.png) | Elimina la plantilla existente. <aside class="starlight-aside starlight-aside--caution"><p class="starlight-aside__title">Atención</p>La plantilla no podrá eliminarse si está en uso por algún grupo de alerta. La plantilla **Predeterminada** forma parte del sistema y tampoco podrá ser eliminada.</aside> |
...
En esta pantalla el usuario puede personalizar el mensaje enviado por los grupos de alerta. Se listan las variables disponibles que se pueden utilizar y un lenguaje de programación sencillo para trabajar con condiciones.
...
| Opción | Descripción |
| :--- | :--- |
| **Nombre** | Es el nombre que se mostrará en la pantalla de plantillas, así como el que se mostrará para selección al editar la opción de grupos de alerta. |
| **Cuerpo** | Este es el texto del mensaje de alerta que será enviado al usuario. Cuando se utilicen variables o comandos de programación, éstos deberán estar obligatoriamente entre "{{ }}". |
| **Variables del sistema** | Son las variables con información del sistema que están disponibles para usarse en las plantillas de alerta. Para agilizar la personalización del texto del cuerpo del mensaje con las variables, basta ejecutar un "doble clic" sobre la variable deseada para que ésta se inserte en el texto. |
