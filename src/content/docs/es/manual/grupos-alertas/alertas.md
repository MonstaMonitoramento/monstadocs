...
| ![image-1732710190977.png](/src/assets/images/p37_image-1732710190977.png) | **Eliminar Grupo**: Elimina el grupo seleccionado. Atención: Solo se permitirá eliminar un grupo cuando este no forme parte de ningún dispositivo o monitor. Esta información puede obtenerla en la pestaña [Membros](#membros) al editar el grupo. |
