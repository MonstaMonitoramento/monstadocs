...
**Desde la pantalla del Trial**:

Si estás utilizando la versión Trial de Monsta, basta con hacer clic en el botón "Suscribirse" en la esquina superior derecha de tu pantalla. Serás redirigido a nuestro sitio en el área de pago. Elige tu plan y la forma de cobro y cuando se efectúe el pago, tu Trial estará disponible como versión con licencia de forma automática.
