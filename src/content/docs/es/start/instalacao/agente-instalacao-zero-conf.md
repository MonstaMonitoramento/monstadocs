...
- Con una cuenta de usuario con permisos de administrador, ejecute el instalador "agent.msi".
...
| &nbsp; | &nbsp; |
| --- | --- |
| `LICENSEKEY=\[chave de licença\]` | Indica la clave de licencia a la que el Agente deberá conectarse. |
