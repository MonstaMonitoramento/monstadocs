...
sidebar:
  order: 4
---
Esta documentación describe el funcionamiento y la arquitectura del **Agente Monsta**, una herramienta para ampliar el monitorización de su plataforma a redes remotas y distribuidas, garantizando rendimiento y seguridad mediante el protocolo QUIC.
...
| Opción | Descripción |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `LICENSEKEY=[chave de licença]` | Indica la clave de licencia a la que el Agente debe conectarse. Consejo: La clave de licencia puede obtenerse en Monsta dentro del menú "Configuração" en la opción "Agentes". Se muestra en la esquina superior derecha. |
...
Para abarcar toda la red remota con un único agente, registre los nuevos dispositivos en Monsta y defina que el dispositivo está bajo la **jerarquía** del host donde está instalado el Agente.
