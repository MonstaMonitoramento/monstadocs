...
Esta documentación describe el funcionamiento y la arquitectura del **Agente Monsta**, una herramienta para extender la supervisión de su plataforma a redes remotas y distribuidas, garantizando rendimiento y seguridad mediante el protocolo QUIC.
...
El instalador **agent.msi** admite parámetros de línea de comando para automatización. Integrado con la utilidad **msiexec**, permite instalar mediante **GPO**, eliminando la necesidad de intervención manual en la interfaz gráfica.
...
- Para garantizar conexiones directas, abra el puerto **58580/UDP** (salida) en el cortafuegos de su servidor de Monsta hacia Internet;  
