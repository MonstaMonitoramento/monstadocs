---
title: Sincronizando la Hora en Servidores Linux
sidebar:
  order: 11
---
...
1. **Liste os Fusos Horários**:
   ...
   ```
   (Reemplace por la zona horaria deseada)
...
```shell
sudo hwclock -w  # Escribe la hora del sistema (soft) en el hardware (hard)
```