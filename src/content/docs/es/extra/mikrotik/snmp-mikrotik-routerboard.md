...
![image-1645205030195.png](/src/assets/images/p16_image-1645205030195.png)Introduzca el usuario y la contraseña de su dispositivo (el predeterminado es admin y deje la contraseña en blanco). A continuación, en el menú de la izquierda, haga clic en IP y debajo haga clic en SNMP:

![image-1645205057404.png](/src/assets/images/p16_image-1645205057404.png)Rellene los campos “Contact Info” con la persona responsable de contacto de este dispositivo y el campo “Location” con su ubicación.

## Configurando una Comunidad

A continuación, haga clic en el botón “Communities”, se mostrará la siguiente pantalla:

![image-1645205091972.png](/src/assets/images/p16_image-1645205091972.png)  
...
![image-1645205110836.png](/src/assets/images/p16_image-1645205110836.png)  
...
![image-1645205142984.png](/src/assets/images/p16_image-1645205142984.png)  
