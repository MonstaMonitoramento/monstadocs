...
To install the Monsta Probe, visit our [Downloads](https://monsta.com.br/downloads/) area or see the article [Probe: Windows Monitoring](/en/start/instalacao/sonda-windows).
...
To install a Monsta Agent, visit our [Downloads](https://monsta.com.br/downloads/) area or see the article [Agent: Zero Conf Installation](/en/start/instalacao/agente-instalacao-zero-conf).
