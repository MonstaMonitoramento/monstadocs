...
| ![image-1732710190977.png](/src/assets/images/p37_image-1732710190977.png) | **Delete Group**: Deletes the selected group. AttentionIt will only be allowed to remove a group when it is not part of any device or monitor. You can obtain this information on the [Membros](#membros) tab when editing the group. |
