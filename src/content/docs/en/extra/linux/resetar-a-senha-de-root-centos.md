...
![image-1740673001214.png](/src/assets/images/p81_image-1740673001214.png)

Press the "e" key to open the boot configuration edit mode as shown below:

![image-1740673021815.png](/src/assets/images/p81_image-1740673021815.png)

Find the line that starts with "linux" or "linux16" and append "rw init=/sysroot/bin/bash" to the end as in the example below:

![image-1740673058015.png](/src/assets/images/p81_image-1740673058015.png)

Press CTRL+X to boot Linux with the new settings. The following screen should appear:

![image-1740673113884.png](/src/assets/images/p81_image-1740673113884.png)
